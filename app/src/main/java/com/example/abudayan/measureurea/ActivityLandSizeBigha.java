...
public class ActivityLandSizeBigha extends AppCompatActivity {
    /**
    ...
    final  static String putUnit1 = "১ম একক", putLand1 = "১ম এককে জমির পরিমাণ", putTotalLeaf = "সর্বমোট পাতা";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_land_size_bigha);
